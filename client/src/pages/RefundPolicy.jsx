...
const RefundPolicy = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
            <h1 className="text-4xl font-extrabold text-[#213C51] mb-8 border-b-4 border-orange-500 pb-2 inline-block">Refund and Cancellation Policy</h1>
            
            <div className="text-gray-700 leading-relaxed whitespace-pre-wrap bg-[#E8E2D8]/30 p-8 rounded-3xl border border-[#213C51]/5">
                {settings.refund_policy || `Loading policy...`}
            </div>
            
            <div className="mt-12 p-8 bg-[#213C51]/5 rounded-3xl border border-[#213C51]/10">
                <h2 className="text-xl font-bold text-[#213C51] mb-4">Contact Information</h2>
                <p className="text-gray-600 mb-4">
                    For any refund or cancellation requests, please get in touch:
                </p>
